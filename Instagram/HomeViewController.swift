...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //コメントボタンのアクション追加
        cell.commentButton.addTarget(self, action:#selector(baloonButton(sender:event:)), for: UIControlEvents.touchUpInside)
    ...
    //コメントボタンが押された時に呼ばれる
    func baloonButton(sender: UIButton, event:UIEvent){
        // タップされたセルのインデックスを求める
